...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_avalon_st_adapter_channel_adapter_0.sv" -work channel_adapter_0      -cdslib ./cds_libs/channel_adapter_0.cds.lib     
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_avalon_st_adapter.v"                    -work avalon_st_adapter      -cdslib ./cds_libs/avalon_st_adapter.cds.lib     
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_scaler_0.v"                       -work video_scaler_0         -cdslib ./cds_libs/video_scaler_0.cds.lib        
