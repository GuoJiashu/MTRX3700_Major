...
# ----------------------------------------
# ACDS 20.1 711 win32 2024.09.19.11:21:54
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_avalon_st_adapter_channel_adapter_0.sv" -work channel_adapter_0     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_avalon_st_adapter.v"                    -work avalon_st_adapter     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_scaler_0.v"                       -work video_scaler_0        
