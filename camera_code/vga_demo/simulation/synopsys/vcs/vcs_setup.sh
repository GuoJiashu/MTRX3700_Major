...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/vga_demo_avalon_st_adapter_channel_adapter_0.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/vga_demo_avalon_st_adapter.v \
  $QSYS_SIMDIR/submodules/altera_up_avalon_video_vga_timing.v \
  $QSYS_SIMDIR/submodules/vga_demo_video_vga_controller_0.v \
  ...
  $QSYS_SIMDIR/submodules/vga_demo_video_scaler_0.v \
  $QSYS_SIMDIR/vga_demo.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
